<script>
    ...
    import { properties as invProperties } from "$lib/data/inventory.js";
...
{:else if page === "shop"}
    <div id="shop">
        <Shop title="Properties" items={properties} enabled={invProperties} />
        <Shop title="Trinkets" items={trinkets} enabled={invProperties} />
        <Shop title="Weapons" items={weapons} enabled={invProperties} />
        <Shop title="Servants" items={servants} enabled={invProperties} />
    </div>
{/if}
