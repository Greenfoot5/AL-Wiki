...
<div class="body">
    ...
    <Tabs defaultValue="t5" class="pt-8">
        <Tabs.List>
        ...
        <Tabs.Content value="t4">
            <Callout variant="warning">This page will no longer be actively updated as T5 has been released. Pull requests will still be reviewed.</Callout>
