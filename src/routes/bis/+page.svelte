...
<div class="body">
    ...
    <Callout variant="warning">Many values are now uncertain thanks to an update of version 1.3.0 where base stats and max stats for many items were changed.</Callout>
    ...
    <details>
        <summary><h2>Shoulders</h2></summary>
